...
df = pd.read_csv('C://self_project//data_project//data_project_file//dataset//real_estate//KB_original2/아파트 매매평균가격.csv',encoding='utf-8')
...
df.to_csv('data_project_file/dataset/real_estate/KB_preprocessing1/KB아파트 매매평균가격.csv', encoding='utf-8') # csv 파일로 저장